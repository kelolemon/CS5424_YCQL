...
func CreateNewOrder(OrderID int32, OderWarehouseID int32, OrderDistrictID int32, OrderCustomerID int32, OrderCarrierID int32, OOLCent int64, OAllLocal int64, OEntryDate int64) (err error) {
