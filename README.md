...
./cassandra-loader -f project_files/data_files/order-line-quantity-by-order.csv -host localhost -schema "cs5424.orderlinequantitybyorder(w_id, d_id, o_id, o_entry_d, ol_quantity_map, items_id_name_map, c_id, c_first, c_middle, c_last)"
